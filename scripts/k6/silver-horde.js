/**
 * Silver tier — 200 concurrent VUs through the load balancer (Nginx on port 80).
 *
 ...
 *
 * Prerequisites: `docker compose up --build -d`, then seed:
 ...
 *   k6 run --summary-export=scripts/k6/summary-silver.json scripts/k6/silver-horde.js
 */
